...
<p align=left><font face="Garamond" size="4">Complétez les phrases avec 
        "pas de" (article indéfini; quantité limitée et imprécise) ou "pas le/la/les" 
        (article défini: généralisation ou chose spécifique) Cliquez "C"--&gt; 
        correction. Correct?--&gt;*astérisques.* Incorrect?--&gt; ====.</font></p>
