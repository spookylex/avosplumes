---
title: "Pas de vs. pas le (1)"
---

### La négation et les articles définis/indéfinis

Complétez les phrases avec "pas de" (article indéfini; quantité limitée et imprécise) ou "pas le/la/les" (article défini: généralisation ou chose spécifique) Cliquez "C"--> correction. Correct?-->*astérisques.* Incorrect?--> ====.
